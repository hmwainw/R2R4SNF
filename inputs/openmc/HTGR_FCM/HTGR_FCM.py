...
rad1 = 110.0 # radius of the active core
rad2= rad1+40.0 # radius of the reflector
rad3 = rad2+(304.9-297.3) # radius of the reactor vessel
...
volkernel= N_holes*((np.pi*(triso_spheres[5].r**2-triso_spheres[4].r**2)*1.0))*(19+15)+((np.pi*(triso_spheres[5].r**2-triso_spheres[4].r**2)*1.0))*12
print(volkernel)
